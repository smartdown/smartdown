(function (global, factory) {
	...
	var ohm = /*@__PURE__*/getDefaultExportFromCjs(ohm_min.exports);
	...
	const fundef = (name,args,block) => new FunctionDefinition(name,args,block);
	...
	browser.make = function(width,height) {
	    ...
	    function (scope, data, width, height, fill) {
	        return new CanvasResult((canvas) => {
	            const mouseEventHandler = async (name, e) => {
	              ...
	              let newResult = null;
	              if (fun) {
	                await fun.do_apply(scope, [scalar(e.offsetX), scalar(e.offsetY)]);
  ...
  comment
	...
	async function parseAndEvalWithScope(code, localScope) {
	...
	exports.FilamentFunction = FilamentFunction;
	exports.FilamentFunctionWithScope = FilamentFunctionWithScope;
	...
	exports.make_standard_scope = make_standard_scope;
	exports.parseAndEvalWithScope = parseAndEvalWithScope;
